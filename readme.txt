TIDEngine - version 1.0 beta                                     TIDEngine Logo 256x256
...
TIDEngine Logo  TIDEngine MAIN ASPECTS:
...
TIDEngine Logo  BROWSER COMPATIBILITY:
...
TIDEngine Logo  FURTHER VERSIONS FEATURES:
...
TIDEngine Logo  TIDEngine Template System LICENCE:

TIDEngine Template System is released under Multi Licencing Conditions Original Licence is:

    * Site Info Service Modification of Free Non-Commercial License.

Site Info Service Licence
Summary:

    * Can be used on Personal Website, Personal Projects and Open Source Project
...
Under Site Info Service Licence there are conditions for use of:

    * GPL and
    * Modified BSD License

Complete TIDEngine Template System Licence you can find on Licence Page